                    ...
                    <Box sx={
                        ...
                        <form onSubmit={onSubmit}
                            ...
                            <Grid container
                                ...
                                <Grid item
                                    xs={12}>
                                    <TextField required fullWidth id="nom" label="Nom De L'Entreprise" name="Nom" autoComplete="Nom De L'Entreprise"
                                        value={
                                            state.Nom
                                        }
                                ...
                                <Grid item
                                    xs={12}
                                    sm={6}>
                                    <TextField required fullWidth id="Code Postal" label="Code Postal" name="CodePostal" autoComplete="Code-Postal"
                                        value={
                                            state.CodePostal
                                        }
                                        onChange={formValChange}
                                        className={
                                            (isError.CodePostal.length) > 0 ? "is-invalid form-control" : "form-control"
                                        }/> {
