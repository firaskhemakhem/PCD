...
class HeaderCan extends Component {
  render(){
    return (
      <div>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
              ...
              <div class="dropdown text-end">
                ...
                <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                  <li>
                    <NavLink to={"/CandProfile/"+this.props.dataFromParent} /**/>
                      <Button 
                        type="button"
                        class="btn btn-outline-secondary"
                        fullwidth
                        variant="contained"
                        onClick={()=>localStorage.setItem("Id_Utilisateur",this.props.dataFromParent)} 
                        >
                        Profil
                      </Button>
                </NavLink>
